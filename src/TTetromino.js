...
export default class TTetromino extends Tetromino{
    ...
    constructor(pos) {
        super(pos ,'magenta');
        this.blocks.push(new Block(this.pos, this.color),new Block(new Vec2(this.pos.x-1,this.pos.y+1), this.color),new Block(new Vec2(this.pos.x,this.pos.y+1), this.color),new Block(new Vec2(this.pos.x+1,this.pos.y+1), this.color));
        this.Forms={
            form1 : "form1",
            form2 : "form2",
            form3 : "form3",
