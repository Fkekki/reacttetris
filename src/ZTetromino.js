...
export default class ZTetromino extends Tetromino{
    ...
    constructor(pos) {
        super(pos ,'red');
        this.blocks.push(new Block(this.pos, this.color),new Block(new Vec2(this.pos.x+1,this.pos.y), this.color),new Block(new Vec2(this.pos.x+1,this.pos.y+1), this.color),new Block(new Vec2(this.pos.x+2,this.pos.y+1), this.color));
        this.Forms={
            form1 : "form1",
            form2 : "form2",
            form3 : "form3",
