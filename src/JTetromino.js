...
export default class JTetromino extends Tetromino{
    ...
    constructor(pos) {
        super(pos ,'blue');
        this.blocks.push(new Block(this.pos, this.color),new Block(new Vec2(this.pos.x,this.pos.y+1), this.color),new Block(new Vec2(this.pos.x+1,this.pos.y+1), this.color),new Block(new Vec2(this.pos.x+2,this.pos.y+1), this.color));
        this.Forms={
            form1 : "form1",
            form2 : "form2",
            form3 : "form3",
    ...
    ChangeForm(stack)
    {
        if(this.Form===this.Forms.form1) {
            ...
            this.blocks[0].position.y+=1;
            this.blocks[1].position.x+=1;
            this.blocks[1].position.y+=1;
            this.blocks[2].position.y -= 1;
            this.blocks[3].position.y -= 1;
            ...
            this.blocks[0].position.x-=2;
            this.blocks[1].position.x+=1;
            this.blocks[1].position.y+=1;
            this.blocks[2].position.y -= 1;
            this.blocks[3].position.x -= 1;
